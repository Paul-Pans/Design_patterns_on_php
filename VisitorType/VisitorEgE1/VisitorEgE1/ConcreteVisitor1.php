...
/**
 * Конкретные Посетители реализует несколько версий одного и того же алгоритма,
 ...
 * бы полезно хранить некоторое промежуточное состояние алгоритма при выполнение методов
