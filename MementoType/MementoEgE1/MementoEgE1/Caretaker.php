...
/**
 * coretaker - смотритель
 * 
 * Опекун не зависитот класса конкретного снимка. Таким образом,
 * он не имеет доступа к состоянию создателя, хранящемуся внутри
 * снимка. Он работает со всеми снимками через базовый интерфейс Снимка.
 * 
 */
...
class Caretaker
{
    ...
    {
        echo "<br> Caretaker: Saving Originator state... </br>";
